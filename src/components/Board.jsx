        ...
        <div className="flex flex-col justify-center items-center w-screen h-screen gap-10">
            ...
            {openModalSnakeGuide && <div className="absolute flex justify-center items-center w-screen h-screen z-20 top-0 bg-black bg-opacity-50">
                <div className=" relative flex flex-col justify-center items-center bg-black p-5 max-h-[80vh] w-[90%] sm:w-2/3 md:w-1/2 lg:w-1/3 xl:w-1/4 rounded gap-2">
                    ...
                    <p className="font-sans text-white text-base md:text-xl text-justify">Utilisez les flèches du clavier pour diriger le serpent et manger la nourriture. Chaque fois que vous mangez, le serpent grandit. Faites attention à ne pas vous mordre la queue ou à sortir des limites du plateau de jeu !</p>
                </div>
            </div>}
        </div >
    )
